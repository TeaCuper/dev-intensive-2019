...
fun Date.humanizeDiff(date: Date = Date()): String {
    var diftime = this.time - date.time
    diftime = diftime / 1000 * 1000
    ...
    if (past) {
        val seconds = diftime / 1000
        val minutes = diftime / (60 * 1000)
        val hours = diftime / (60 * 60 * 1000)
        val days = diftime / (24 * 60 * 60 * 1000)
        ...
        val seconds = diftime / 1000
        val minutes = diftime / (60 * 1000)
        val hours = diftime / (3600 * 1000)
        val days = diftime / (24 * 3600 * 1000)
